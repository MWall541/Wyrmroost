...
public class Recipes extends RecipeProvider
{
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer)
    {
        ...
        // Materials
        ShapelessRecipeBuilder.shapelessRecipe(WRItems.BLUE_GEODE.get())
        ...
        ShapelessRecipeBuilder.shapelessRecipe(WRBlocks.BLUE_GEODE_BLOCK.get())
                ...
                .addCriterion("has_block", hasItem(WRBlocks.BLUE_GEODE_BLOCK.get()))
                .build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(WRItems.RED_GEODE.get())
        ...
        ShapelessRecipeBuilder.shapelessRecipe(WRItems.PURPLE_GEODE.get())
        ...
        oreSmeltRecipe(WRBlocks.RED_GEODE_ORE.get(), WRItems.RED_GEODE.get(), 1f, 200, consumer, "purplegeode");
