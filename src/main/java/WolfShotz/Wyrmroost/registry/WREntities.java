...
public class WREntities
{
    ...
    public static final RegistryObject<EntityType<CanariWyvernEntity>> CANARI_WYVERN = register("canari_wyvern", buildCreatureEntity(CanariWyvernEntity::new).size(0.7f, 0.85f));
