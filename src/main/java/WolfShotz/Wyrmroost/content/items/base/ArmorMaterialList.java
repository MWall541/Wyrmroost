...
//    CANARI("canari", new int[]{2, 3, 4, 1}, 0f, 15, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, WRItems.CANARI_FEATHER);
    ...
    ArmorMaterialList(int[] dmgReduction, float toughness, int durability, int enchantability, SoundEvent sound, Supplier<Item> repairMaterial)
    {
    ...
    ArmorMaterialList(int[] dmgReduction, float toughness, int durability, int enchantability, SoundEvent sound, Supplier<Item> repairMaterial, Rarity rarity)
    {
        this(dmgReduction, toughness, durability, enchantability, sound, repairMaterial);
        this.rarity = rarity;
    }
