...
{
    GEODE("geode", new int[] {4, 7, 9, 4}, 2.8f, 48, 25, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, ModItems.GEODE_BLUE.get()),
    GEODERED("geode_red", new int[] {4, 8, 9, 5}, 3f, 52, 25, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, ModItems.GEODE_RED.get()),
    GEODEPURPLE("geode_purple", new int[] {6, 10, 12, 8}, 4f, 60, 28, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, ModItems.GEODE_RED.get()),
    PLATINUM("platinum", new int[] {2, 5, 7, 2}, 0.2f, 20, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, ModItems.PLATINUM_INGOT.get());
