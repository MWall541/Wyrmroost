...
public class SilverGliderModel extends AdvancedEntityModel {
    public SilverGliderEntity glider;
    ...
    public SilverGliderModel() {
        ...
        this.membrane2R.setRotationPoint(1.0F, 0.0F, 0.0F);
        ...
        this.membrane3L = new AdvancedRendererModel(this, 63, 100);
        this.membrane3L.setRotationPoint(1.3F, 0.0F, -1.4F);
        this.membrane3L.addBox(0.0F, 0.0F, -0.5F, 12, 0, 18, 0.0F);
        ...
        this.membrane2L.setRotationPoint(-1.0F, 0.0F, 0.0F);
        ...
        this.membrane4L = new AdvancedRendererModel(this, 38, 100);
        this.membrane4L.setRotationPoint(0.0F, 0.1F, 0.0F);
        this.membrane4L.addBox(0.0F, 0.0F, -0.5F, 11, 0, 18, 0.0F);
        this.setRotateAngle(membrane4L, 0.0F, 0.17453292519943295F, 0.0F);
        ...
        this.phalangeR21.setRotationPoint(-14.0F, -0.2F, 0.5F);
        ...
        this.membrane4R = new AdvancedRendererModel(this, 63, 100);
        this.membrane4R.mirror = true;
        this.membrane4R.setRotationPoint(-1.3F, 0.0F, -1.4F);
        this.membrane4R.addBox(-12.0F, 0.0F, -0.5F, 12, 0, 18, 0.0F);
        this.setRotateAngle(membrane4R, 0.0F, 0.17453292519943295F, 0.0F);
        ...
        this.phalangeL21.setRotationPoint(14.0F, -0.2F, 0.5F);
        ...
        this.membrane3R.addBox(-11.0F, 0.0F, -0.5F, 11, 0, 18, 0.0F);
        ...
        this.wing2L.addChild(this.membrane3L);
        ...
        this.wing1L.addChild(this.membrane4L);
        ...
        this.wing2R.addChild(this.membrane4R);
    ...
    public void setLivingAnimations(Entity entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
        ...
        Entity entity = glider.getRidingEntity();
        boolean flightFlag = glider.isFlying() || (glider.isRiding() && MathUtils.getAltitude(entity) > 1.3d);
    
        resetToDefaultPose();
        animator.update(glider);
        
        if (currentAnim == SilverGliderEntity.TAKE_OFF_ANIMATION) {
            System.out.println("true");
            takeOffAnim();
        }
    
        setPositions(flightFlag);
    
        if (flightFlag) { // Should only perform these anims during flight
            ...
            for (AdvancedRendererModel toe : new AdvancedRendererModel[] {toe1L, toe2L, toe3L})
                walk(toe, globalSpeed - 0.1f, 0.4f, true, -0.6f, 0, limbSwing, limbSwingAmount);
            for (AdvancedRendererModel toe : new AdvancedRendererModel[] {toe1R, toe2R, toe1R_1})
                walk(toe, globalSpeed - 0.1f, 0.4f, false, -0.6f, 0, limbSwing, limbSwingAmount);
            ...
            if (currentAnim == SilverGliderEntity.SLEEP_ANIMATION) sleepAnim();
    ...
    /**
     * Preset positions in prep for anims
     */
    private void setPositions(boolean flight) {
        ...
        if (flight) {
            ...
            mainbody.rotateAngleX = (float) -lookVec.y * 1.2f;
        } else {
            if (!glider.isRiding()) {
                // Default ground pose
                // Left Wing
                ...
                membrane2R.rotateAngleZ = -0.08f;
                membrane4R.rotateAngleY = 0.9f;
            } else {
                // Wing Poses for riding
                // Left Wing
                wing1L.rotateAngleY = -1.2f;
                wing1L.rotateAngleX = 2.3f;
                wing1L.rotateAngleZ = -1f;
                wing2L.rotateAngleY = 1.7f;
                membrane4L.rotateAngleY = 0.9f;
                phalangeL11.rotateAngleY = -1.6f;
                phalangeL21.rotateAngleY = -2f;
        
                // Right Wing
                wing1R.rotateAngleY = 1.2f;
                wing1R.rotateAngleX = 2.3f;
                wing1R.rotateAngleZ = 1f;
                wing2R.rotateAngleY = -1.7f;
                membrane3R.rotateAngleY = -0.9f;
                phalangeR11.rotateAngleY = 1.6f;
                phalangeR21.rotateAngleY = 2f;
            }
    ...
    private void staySleeping(float frame) {
        ...
        wing1L.rotateAngleY = -0.6f;
        wing2L.rotateAngleY = 2.2f;
        phalangeL11.rotateAngleY = -2.1f;
        phalangeL21.rotateAngleY = -2.3f;
        membrane3L.rotateAngleY = -1.6f;
        membrane4L.rotateAngleY = 0.3f;
    ...
    private void sleepAnim() {
        ...
        animator.rotate(membrane3L, 0, -0.78f, 0);
        animator.rotate(membrane4L, 0, 0.15f, 0);
        animator.rotate(phalangeL11, 0, -0.35f, 0);
        animator.rotate(phalangeL21, 0, -0.35f, 0);
    ...
    private void wakeAnim() {
        animator.setAnimation(SilverGliderEntity.WAKE_ANIMATION);
    ...
    private void takeOffAnim() {
        animator.setAnimation(SilverGliderEntity.TAKE_OFF_ANIMATION);
        
        animator.startKeyframe(20);
        
        if (glider.isRiding()) {
            animator.rotate(wing1L, -2.3f, 0.9f, 1f);
            animator.rotate(wing2L, 0, -1.4f, 0);
            animator.rotate(membrane4L, 0, -0.75f, 0);
            animator.rotate(phalangeL11, 0, 1.6f, 0);
            animator.rotate(phalangeL21, 0, 1.4f, 0);
