...
public class SilverGliderModel extends AdvancedEntityModel {
    ...
    public SilverGliderModel() {
        ...
        this.phalangeL21.setRotationPoint(9.0F, -0.3F, 0.5F);
        ...
        this.wing2L.addBox(0.0F, -1.0F, -1.0F, 10, 2, 2, 0.0F);
        ...
        this.membrane2R.addBox(-25.0F, 0.0F, -0.5F, 25, 0, 18, 0.0F);
        ...
        this.phalangeR21.setRotationPoint(-9.0F, -0.3F, 0.5F);
        ...
        this.phalangeL11.setRotationPoint(9.0F, -0.3F, -0.5F);
        ...
        this.phalangeR11.setRotationPoint(-9.0F, -0.3F, -0.5F);
        ...
        this.wing2R.addBox(-10.0F, -1.0F, -1.0F, 10, 2, 2, 0.0F);
        ...
        this.membrane3L.addBox(0.0F, 0.0F, -0.5F, 18, 0, 18, 0.0F);
        ...
        this.membrane2L.addBox(0.0F, 0.0F, -0.5F, 25, 0, 18, 0.0F);
        ...
        this.membrane3R.addBox(-18.0F, 0.0F, -0.5F, 18, 0, 18, 0.0F);
        ...
        this.phalangeR22.addBox(-15.0F, -0.5F, -0.5F, 15, 1, 1, 0.0F);
        ...
        this.phalangeL22.addBox(0.0F, -0.5F, -0.5F, 15, 1, 1, 0.0F);
