...
public class TarragonTomeScreen extends Screen
{
    ...
    {
        super(new TranslationTextComponent("Tarragon Tome"));
        if (!(tome.getItem() instanceof TarragonTomeItem))
            throw new UnsupportedOperationException("Not a tarragon tome item!");
        this.TOME = tome;
    }
    ...
    {
        addButton(new Button(width / 2 - 100, 196, 200, 20, I18n.format("io.modbook.close"), func -> minecraft.displayGuiScreen(null)));
    ...
    private static String clean(String string, String toReplace)
    {
        return ModUtils.replaceFirst(string, toReplace, "").trim();
    }
