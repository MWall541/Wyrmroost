...
public class Page
{
    ...
    {
        items.add(new Triple<>(item, x, y));
    }

    public void addImage(ResourceLocation loc, int x, int y, int imgWidth, int imgHeight)
    {
        images.add(new ImageCache(loc, x, y, imgWidth, imgHeight));
    }
}
