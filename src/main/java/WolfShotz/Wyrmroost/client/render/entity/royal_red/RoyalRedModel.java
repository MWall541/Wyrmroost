...
public class RoyalRedModel extends WREntityModel<RoyalRedEntity>
{
    ...
    public RoyalRedModel()
    {
        ...
        this.setRotateAngle(arm2R, -1.1383037381507017F, 0f, 0.0F);
        ...
        this.arm1L.setRotationPoint(2.0F, 0f, -2.5F);
...
//        limbSwingAmount = 0.5f;
        ...
        {
            bob(body2, globalSpeed - 0.125f, 0.25f, false, limbSwing, limbSwingAmount);

            flap(palmL, globalSpeed - 0.125f, 0.25f, false, 1, 0, limbSwing, limbSwingAmount);
            flap(palmR, globalSpeed - 0.125f, 0.25f, true, 1, 0, limbSwing, limbSwingAmount);

            walk(arm1R, globalSpeed - 0.125f, 0.1f, false, -1, 0, limbSwing, limbSwingAmount);
            walk(arm2R, globalSpeed - 0.125f, 0.05f, false, -1, 0, limbSwing, limbSwingAmount);
            walk(arm1L, globalSpeed - 0.125f, 0.1f, false, -1, 0, limbSwing, limbSwingAmount);
            walk(arm2L, globalSpeed - 0.125f, 0.05f, false, -1, 0, limbSwing, limbSwingAmount);
    ...
    public void idle(float frame)
    {
        ...
        if (entity.isFlying())
        {
            flap(wingR1, globalSpeed, 0.65f, false, 0, 0, frame, 0.5f);
            flap(wingR2, globalSpeed, 1.5f, false, -1f, -0.5f, frame, 0.5f);
            flap(membraneR2, globalSpeed, 1.5f, false, -1f, -0.5f, frame, 0.5f);
            flap(wingL1, globalSpeed, 0.65f, true, 0, 0, frame, 0.5f);
            flap(wingL2, globalSpeed, 1.5f, true, -1f, -0.5f, frame, 0.5f);
            flap(membraneL2, globalSpeed, 1.5f, true, -1f, -0.5f, frame, 0.5f);
        }
        else
        {
    ...
    public void fly(float amount)
    {
        ...
        rotate(wingR1, 0.18f, -0.4f, -0.77f);
        rotate(wingR2, 0f, 1.8f, 0);
        rotate(palmR_1, 0, -1f, 0);
        rotate(fingerR1part1, 0, -0.95f, 0);
        rotate(fingerR2part1, 0, -0.58f, 0);
        rotate(fingerR3part1, 0, -0.1f, 0);
        rotate(fingerR4part1, 0, 0.5f, 0);
        rotate(membraneR3, 0, -1.35f, 0);

        rotate(wingL1, 0.18f, 0.4f, 0.77f);
        rotate(wingL2, 0f, -1.8f, 0);
        rotate(palmL_1, 0, 1f, 0);
        rotate(fingerL1part1, 0, 0.95f, 0);
        rotate(fingerL2part1, 0, 0.58f, 0);
        rotate(fingerL3part1, 0, 0.1f, 0);
