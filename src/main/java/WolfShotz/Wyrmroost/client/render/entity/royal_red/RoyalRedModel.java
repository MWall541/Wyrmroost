...
public class RoyalRedModel extends WREntityModel<RoyalRedEntity>
{
    ...
    public RoyalRedModel()
    {
        ...
        this.body2.setRotationPoint(0.01F, -1.7F, 2.5F);
        this.body2.addBox(-3.0F, -1.0F, 0.0F, 6, 6, 7, 0.0F);
        ...
        this.leg1L.setRotationPoint(1.4F, 2.0F, 4.0F);
        ...
        this.arm1L.setRotationPoint(2.0F, 0.0F, -0.5F);
        ...
        this.leg1R.setRotationPoint(-1.4F, 2.0F, 4.0F);
        ...
        this.membraneR2.setRotationPoint(-10.0F, 0.1F, 0.0F);
        ...
        this.neck1.setRotationPoint(0.0F, -0.7F, -2.5F);
        ...
        this.membraneR1.setRotationPoint(-10.0F, 0.0F, 0.0F);
        ...
        this.membraneL1.setRotationPoint(0.0F, 0.0F, 0.0F);
        ...
        this.body1.setRotationPoint(0.0F, -22.5F, -14.6F);
        this.body1.addBox(-3.0F, -3.0F, -3.5F, 6, 6, 7, 0.0F);
        ...
        this.arm1R.setRotationPoint(-2.0F, 0.0F, -0.5F);
        this.arm1R.addBox(-2.0F, 0.0F, -1.5F, 2, 5, 3, 0.0F);
        this.setRotateAngle(arm1R, 0.7285004297824331F, 0.0F, 0.0F);
        this.membraneL2 = new WRModelRenderer(this, 71, 82);
        this.membraneL2.mirror = true;
        this.membraneL2.setRotationPoint(10.0F, 0.1F, 0.0F);
        ...
        this.wingR1.setRotationPoint(-2.0F, -1.8F, -1.3F);
        ...
        this.tail1.setRotationPoint(0.0F, 1.8F, 6.0F);
        ...
        this.wingL1.setRotationPoint(2.0F, -1.8F, -1.3F);
    ...
    public void render(MatrixStack ms, IVertexBuilder buffer, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha)
    {
        ...
        ms.translate(0, 1, 0.75f);
        body1.render(ms, buffer, packedLightIn, packedOverlayIn);
        ms.pop();
    }

    @Override
    public void setRotationAngles(RoyalRedEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
