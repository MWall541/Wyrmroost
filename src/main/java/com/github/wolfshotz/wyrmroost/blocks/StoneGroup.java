...
public class StoneGroup
{
    ...
    private StoneGroup(String name, Builder builder)
    {
        ...
        this.pressurePlate = builder.pressurePlate == null? null : register(name + "_pressure_plate", () -> builder.pressurePlate.apply(AbstractBlock.Properties.copy(getStone())));
    ...
    public static Builder base(AbstractBlock.Properties props)
    {
    ...
    {
        private final AbstractBlock.Properties props;
        ...
        private Function<AbstractBlock.Properties, Block> pressurePlate;
        private Supplier<Block> button;
        private Supplier<Block> cracked;
        private Supplier<Block> chiseled;

        public Builder(AbstractBlock.Properties props)
        {
            this.props = props;
        ...
        {
            this.stairs = stone -> new StairsBlock(stone::defaultBlockState, props);
            return this;
        }
