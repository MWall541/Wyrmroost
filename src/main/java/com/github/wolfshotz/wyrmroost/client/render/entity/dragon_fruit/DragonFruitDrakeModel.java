...
public class DragonFruitDrakeModel extends WREntityModel<DragonFruitDrakeEntity>
{
    ...
    public DragonFruitDrakeModel()
    {
        ...
        BackLeaf2Middle.setPivot(0.0F, -2.5F, 0.1F);
        ...
        BackLeafL_1.setPivot(-2.1F, -2.5F, 2.6F);
        ...
        shape71.mirror = true;
        shape71.setPivot(-2.5F, -1.1F, -0.1F);
        ...
        LegfrontL1.setPivot(-3.3F, 1.2F, -1.8F);
        ...
        BackLeafMiddle.setPivot(0.0F, -3.0F, -1.6F);
        ...
        LegfrontL3.setPivot(0.01F, 0.1F, 5.0F);
        ...
        Neck2Leaf.setPivot(0.0F, -1.1F, -2.5F);
        ...
        frontfootR.setPivot(-0.01F, -0.5F, 2.8F);
        ...
        LegfrontR3.setPivot(-0.01F, 0.1F, 5.0F);
        ...
        LegSegmentL2.setPivot(0.1F, 1.0F, 3.5F);
        ...
        NeckLeaf3.setPivot(0.0F, -1.2F, -2.3F);
        ...
        LegSegmentL3.setPivot(0.01F, -0.4F, 5.7F);
        ...
        BackLeafR.setPivot(2.5F, -3.0F, 0.4F);
        ...
        Tail2.setPivot(0.01F, 0.1F, 3.7F);
        ...
        Neck1Leaf.setPivot(0.0F, -1.1F, -2.8F);
        ...
        BackLeafR_1.setPivot(1.9F, -2.5F, 2.6F);
        ...
        SideLeaf1R.setPivot(3.9F, -1.1F, -3.0F);
        ...
        SideLeaf1L.setPivot(-4.0F, -1.1F, -3.0F);
        ...
        Tail4.setPivot(0.01F, -0.7F, 2.9F);
        ...
        TailLeaf3.setPivot(-0.1F, -1.7F, 1.8F);
        ...
        frontfootL.setPivot(0.01F, -0.5F, 2.8F);
        ...
        LegfrontL2.setPivot(0.3F, 0.0F, 5.9F);
        ...
        Tail6.setPivot(-0.01F, -0.1F, 4.0F);
        ...
        shape71_1.setPivot(2.5F, -1.1F, -0.1F);
        ...
        TailLeaf2.setPivot(0.0F, -1.8F, 1.8F);
        ...
        LegfrontR1.setPivot(3.3F, 1.2F, -1.8F);
        ...
        BackLeaf1.setPivot(-0.3F, -1.1F, 1.8F);
        ...
        LegfrontR2.setPivot(-0.1F, 0.0F, 5.9F);
        ...
        LegSegmentR1.setPivot(0.3F, 4.3F, 0.0F);
        ...
        backfootR.setPivot(0.01F, 0.0F, 1.6F);
        ...
        neck4.setPivot(0.0F, -0.05F, -3.2F);
        ...
        LegSegmentL1.setPivot(-0.2F, 4.3F, 0.0F);
        ...
        SideLeaf2L.setPivot(-4.0F, 0.4F, 1.6F);
        ...
        TailLeaf4.setPivot(-0.2F, -1.1F, 1.8F);
    ...
    @Override
    public void setAngles(DragonFruitDrakeEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    ...
    @Override
    public void animateModel(DragonFruitDrakeEntity fruitDrake, float limbSwing, float limbSwingAmount, float partialTick)
    {
        float frame = partialTick + fruitDrake.age;
