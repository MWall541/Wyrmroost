...
public class AlpineModel extends WREntityModel<AlpineEntity>
{
    ...
    public AlpineModel()
    {
        ...
        this.fin7.setPivot(0.0F, -3.5F, 4.9F);
        this.fin7.addCuboid(0.0F, -4.0F, -4.0F, 0.0F, 4.0F, 8.0F, 0.0F, 0.0F, 0.0F);
        this.wing3R = new WRModelRenderer(this, 99, 42);
        this.wing3R.mirror = true;
        this.wing3R.setPivot(-19.0F, 0.0F, 0.0F);
        this.wing3R.addCuboid(-15.0F, -1.5F, -5.0F, 15.0F, 3.0F, 10.0F, 0.0F, -0.1F, 0.0F);
        this.setRotateAngle(wing3R, 0.0F, 2.7207937602813157F, 0.0F);
        this.backleg3R = new WRModelRenderer(this, 37, 59);
        this.backleg3R.setPivot(0.0F, 2.8F, 0.1F);
        this.backleg3R.addCuboid(-1.5F, -0.8F, -0.6F, 3.0F, 5.0F, 2.0F, -0.2F, 0.0F, 0.0F);
        this.setRotateAngle(backleg3R, -0.9384635467868342F, 0.0F, 0.0F);
        this.neck3 = new WRModelRenderer(this, 0, 27);
        this.neck3.setPivot(0.0F, 0.0F, -2.0F);
        this.neck3.addCuboid(-2.0F, -2.0F, -3.0F, 4.0F, 4.0F, 3.0F, 0.2F, 0.2F, 0.0F);
        this.setRotateAngle(neck3, -0.4113740993687413F, 0.0F, 0.0F);
        this.leg2R = new WRModelRenderer(this, 37, 59);
        this.leg2R.setPivot(-1.0F, 4.7F, 0.0F);
        this.leg2R.addCuboid(-1.5F, -0.8F, -1.0F, 3.0F, 5.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(leg2R, -0.7305948355374707F, 0.0F, 0.0F);
        this.tailfin7L = new WRModelRenderer(this, 45, 64);
        this.tailfin7L.setPivot(-0.5F, -0.4F, 3.0F);
        this.tailfin7L.addCuboid(0.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(tailfin7L, 0.0F, -0.17453292519943295F, 0.0F);
        this.fin2 = new WRModelRenderer(this, 15, 81);
        this.fin2.setPivot(0.01F, -2.0F, -1.5F);
        this.fin2.addCuboid(0.0F, -4.0F, -2.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.feathers1L = new WRModelRenderer(this, 27, 16);
        this.feathers1L.setPivot(1.5F, -0.5F, 0.5F);
        this.feathers1L.addCuboid(0.0F, -0.5F, -1.5F, 19.0F, 1.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        this.finger4L = new WRModelRenderer(this, 55, 90);
        this.finger4L.setPivot(15.0F, -0.77F, -0.5F);
        this.finger4L.addCuboid(0.0F, -0.5F, -1.0F, 28.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(finger4L, 0.0F, -0.27314402127920984F, 0.0F);
        this.tailfin1L = new WRModelRenderer(this, 45, 64);
        this.tailfin1L.setPivot(-1.5F, -1.0F, 3.0F);
        this.tailfin1L.addCuboid(0.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(tailfin1L, 0.0F, -0.17453292519943295F, 0.0F);
        this.tail2 = new WRModelRenderer(this, 77, 11);
        this.tail2.mirror = true;
        this.tail2.setPivot(0.0F, 0.0F, 5.0F);
        this.tail2.addCuboid(-2.5F, -2.5F, 0.0F, 5.0F, 5.0F, 6.0F, -0.2F, -0.2F, 0.0F);
        this.eyeR = new WRModelRenderer(this, 0, 0);
        this.eyeR.setPivot(-1.7F, -1.0F, -3.5F);
        this.eyeR.addCuboid(-0.5F, -0.5F, -1.0F, 1.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(eyeR, 0.0F, -0.3186971254089062F, 0.0F);
        this.fin8 = new WRModelRenderer(this, 13, 75);
        this.fin8.setPivot(0.01F, -2.0F, 3.0F);
        this.fin8.addCuboid(0.0F, -4.0F, -3.0F, 0.0F, 4.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.neck2 = new WRModelRenderer(this, 0, 27);
        this.neck2.mirror = true;
        this.neck2.setPivot(0.0F, -0.2F, -2.0F);
        this.neck2.addCuboid(-2.0F, -2.0F, -3.0F, 4.0F, 4.0F, 3.0F, 0.3F, 0.3F, 0.0F);
        this.setRotateAngle(neck2, -0.4891369717499691F, 0.0F, 0.0F);
        this.tailfin3L = new WRModelRenderer(this, 45, 64);
        this.tailfin3L.setPivot(-0.5F, -0.8F, 3.0F);
        this.tailfin3L.addCuboid(0.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.wing1R.setPivot(-3.0F, -1.9F, -2.0F);
        this.wing1R.addCuboid(-20.0F, -1.5F, -1.5F, 20.0F, 3.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.foot1L.setPivot(0.0F, 3.6F, 0.2F);
        this.foot1L.addCuboid(-1.5F, -0.1F, -1.0F, 3.0F, 3.0F, 2.0F, -0.1F, 0.0F, 0.0F);
        this.setRotateAngle(foot1L, -0.7723081940074907F, 0.0F, 0.0F);
        this.backfoot1R = new WRModelRenderer(this, 18, 61);
        this.backfoot1R.setPivot(0.0F, 3.6F, 0.7F);
        this.backfoot1R.addCuboid(-1.5F, -0.1F, -1.1F, 3.0F, 3.0F, 2.0F, -0.1F, 0.0F, 0.0F);
        this.setRotateAngle(backfoot1R, -0.7913322855173901F, 0.0F, 0.0F);
        this.wing1L = new WRModelRenderer(this, 89, 14);
        this.wing1L.setPivot(3.0F, -1.9F, -2.0F);
        this.wing1L.addCuboid(0.0F, -1.5F, -1.5F, 20.0F, 3.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(wing1L, 0.0F, -0.9859365237463688F, -0.5916666430576886F);
        this.jaw = new WRModelRenderer(this, 0, 52);
        this.jaw.setPivot(0.0F, 1.5F, -3.8F);
        this.jaw.addCuboid(-1.5F, -0.5F, -5.0F, 3.0F, 1.0F, 5.0F, -0.1F, 0.0F, 0.0F);
        this.finger8L = new WRModelRenderer(this, 116, 90);
        this.finger8L.setPivot(15.0F, -0.73F, 3.5F);
        this.finger8L.addCuboid(0.0F, -0.5F, -1.0F, 14.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(finger8L, 0.0F, -0.956091342937205F, 0.0F);
        this.finger1L = new WRModelRenderer(this, 0, 90);
        this.finger1L.setPivot(15.0F, -0.8F, -3.5F);
        this.finger1L.addCuboid(0.0F, -0.5F, -1.0F, 25.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.tailfin6L = new WRModelRenderer(this, 45, 64);
        this.tailfin6L.setPivot(-0.5F, -0.59F, 3.0F);
        this.tailfin6L.addCuboid(0.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(tailfin6L, 0.0F, -0.17453292519943295F, 0.0F);
        this.fin15 = new WRModelRenderer(this, 28, 75);
        this.fin15.setPivot(0.0F, -0.5F, 3.0F);
        this.fin15.addCuboid(0.0F, -4.0F, -3.0F, 0.0F, 4.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.tail5 = new WRModelRenderer(this, 116, 0);
        this.tail5.setPivot(0.0F, 0.0F, 5.0F);
        this.tail5.addCuboid(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.finger7L = new WRModelRenderer(this, 110, 94);
        this.finger7L.setPivot(15.0F, -0.74F, 2.5F);
        this.finger7L.addCuboid(0.0F, -0.5F, -1.0F, 17.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(finger7L, 0.0F, -0.6829473549475088F, 0.0F);
        this.tailfin4L = new WRModelRenderer(this, 45, 64);
        this.tailfin4L.setPivot(-0.5F, -0.79F, 3.0F);
        this.tailfin4L.addCuboid(0.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(tailfin4L, 0.0F, -0.17453292519943295F, 0.0F);
        this.tail6 = new WRModelRenderer(this, 116, 0);
        this.tail6.setPivot(0.0F, 0.0F, 5.0F);
        this.tail6.addCuboid(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 6.0F, -0.2F, -0.2F, 0.0F);
        this.tailfin2L = new WRModelRenderer(this, 45, 64);
        this.tailfin2L.setPivot(-1.0F, -0.99F, 3.0F);
        this.tailfin2L.addCuboid(0.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(tailfin2L, 0.0F, -0.17453292519943295F, 0.0F);
        this.fin3 = new WRModelRenderer(this, 13, 72);
        this.fin3.setPivot(0.0F, -2.0F, -1.5F);
        this.fin3.addCuboid(0.0F, -4.0F, -2.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.tailfin2R = new WRModelRenderer(this, 45, 64);
        this.tailfin2R.mirror = true;
        this.tailfin2R.setPivot(1.0F, -0.99F, 3.0F);
        this.tailfin2R.addCuboid(-8.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.tailfin6R.setPivot(0.5F, -0.59F, 3.0F);
        this.tailfin6R.addCuboid(-8.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(tailfin6R, 0.0F, 0.17453292519943295F, 0.0F);
        this.wing2R = new WRModelRenderer(this, 89, 28);
        this.wing2R.setPivot(-19.0F, 0.0F, 3.51F);
        this.wing2R.addCuboid(-20.0F, -1.5F, -5.0F, 20.0F, 3.0F, 10.0F, 0.0F, -0.15F, 0.0F);
        this.setRotateAngle(wing2R, 0.0F, -2.6029840357716987F, 0.0F);
        this.finger6L = new WRModelRenderer(this, 65, 94);
        this.finger6L.setPivot(15.0F, -0.75F, 1.5F);
        this.finger6L.addCuboid(0.0F, -0.5F, -1.0F, 21.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(finger6L, 0.0F, -0.500909508638178F, 0.0F);
        this.wing2L = new WRModelRenderer(this, 89, 28);
        this.wing2L.setPivot(19.0F, 0.0F, 3.5F);
        this.wing2L.addCuboid(0.0F, -1.5F, -5.0F, 20.0F, 3.0F, 10.0F, 0.0F, -0.15F, 0.0F);
        this.setRotateAngle(wing2L, 0.0F, 2.6028095987202984F, 0.0F);
        this.neck1 = new WRModelRenderer(this, 0, 18);
        this.neck1.setPivot(0.0F, -0.5F, -4.0F);
        this.neck1.addCuboid(-2.5F, -2.5F, -3.0F, 5.0F, 5.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.feathers3L.setPivot(7.5F, -0.5F, -3.0F);
        this.feathers3L.addCuboid(-7.5F, -0.5F, -1.5F, 15.0F, 1.0F, 10.0F, -0.1F, -0.2F, 0.0F);
        this.body2 = new WRModelRenderer(this, 37, 0);
        this.body2.setPivot(0.0F, 0.6F, 3.5F);
        this.body2.addCuboid(-4.0F, -3.5F, 0.0F, 8.0F, 6.0F, 9.0F, 0.1F, 0.45F, 0.0F);
        this.earL = new WRModelRenderer(this, 0, 68);
        this.earL.setPivot(2.0F, -1.0F, -2.0F);
        this.earL.addCuboid(0.0F, -4.0F, 0.0F, 0.0F, 4.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.finger2R.setPivot(-15.0F, -0.79F, -2.5F);
        this.finger2R.addCuboid(-30.0F, -0.5F, -1.0F, 30.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.feathersR.setPivot(-10.0F, -0.5F, -4.5F);
        this.feathersR.addCuboid(-10.0F, -0.5F, 0.0F, 21.0F, 1.0F, 10.0F, -0.1F, -0.1F, 0.0F);
        this.body1 = new WRModelRenderer(this, 0, 0);
        this.body1.setPivot(0.0F, 12.4F, 0.0F);
        this.body1.addCuboid(-4.0F, -3.5F, -5.0F, 8.0F, 7.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        this.tailfin7R = new WRModelRenderer(this, 45, 64);
        this.tailfin7R.mirror = true;
        this.tailfin7R.setPivot(0.5F, -0.4F, 3.0F);
        this.tailfin7R.addCuboid(-8.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(tailfin7R, 0.0F, 0.17453292519943295F, 0.0F);
        this.teeth2 = new WRModelRenderer(this, 0, 59);
        this.teeth2.setPivot(0.0F, -1.0F, -0.7F);
        this.teeth2.addCuboid(-1.0F, -0.5F, -4.0F, 2.0F, 1.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.snout = new WRModelRenderer(this, 0, 44);
        this.snout.setPivot(0.0F, 0.0F, -3.8F);
        this.snout.addCuboid(-1.5F, -1.0F, -5.0F, 3.0F, 2.0F, 5.0F, 0.0F, 0.0F, 0.0F);
        this.eyeL = new WRModelRenderer(this, 0, 0);
        this.eyeL.mirror = true;
        this.eyeL.setPivot(1.7F, -1.0F, -3.5F);
        this.eyeL.addCuboid(-0.5F, -0.5F, -1.0F, 1.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(eyeL, 0.0F, 0.3186971254089062F, 0.0F);
        this.fin4 = new WRModelRenderer(this, 15, 81);
        this.fin4.setPivot(0.01F, -2.0F, -1.5F);
        this.fin4.addCuboid(0.0F, -4.0F, -2.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.tailfin5R = new WRModelRenderer(this, 45, 64);
        this.tailfin5R.mirror = true;
        this.tailfin5R.setPivot(0.5F, -0.6F, 3.0F);
        this.tailfin5R.addCuboid(-8.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(tailfin5R, 0.0F, 0.17453292519943295F, 0.0F);
        this.feathers2L = new WRModelRenderer(this, 27, 27);
        this.feathers2L.setPivot(10.0F, -0.5F, -4.5F);
        this.feathers2L.addCuboid(-11.0F, -0.5F, 0.0F, 21.0F, 1.0F, 10.0F, -0.1F, -0.1F, 0.0F);
        this.backleg2L = new WRModelRenderer(this, 37, 49);
        this.backleg2L.mirror = true;
        this.backleg2L.setPivot(1.5F, 2.6F, -0.6F);
        this.backleg2L.addCuboid(-1.5F, -0.5F, -1.5F, 3.0F, 4.0F, 3.0F, -0.1F, 0.0F, 0.0F);
        this.setRotateAngle(backleg2L, 0.9292133230565531F, 0.0F, 0.0F);
        this.wing3L = new WRModelRenderer(this, 99, 42);
        this.wing3L.setPivot(19.0F, 0.0F, 0.0F);
        this.wing3L.addCuboid(0.0F, -1.5F, -5.0F, 15.0F, 3.0F, 10.0F, 0.0F, -0.1F, -0.1F);
        this.setRotateAngle(wing3L, 0.0F, -2.7214917748030256F, 0.0F);
        this.tail4 = new WRModelRenderer(this, 95, 0);
        this.tail4.setPivot(0.0F, 0.0F, 5.0F);
        this.tail4.addCuboid(-2.0F, -2.0F, 0.0F, 4.0F, 4.0F, 6.0F, -0.2F, -0.2F, 0.0F);
        this.neck6 = new WRModelRenderer(this, 0, 27);
        this.neck6.mirror = true;
        this.neck6.setPivot(0.0F, 0.0F, -2.0F);
        this.neck6.addCuboid(-2.0F, -2.0F, -3.0F, 4.0F, 4.0F, 3.0F, -0.1F, -0.1F, 0.0F);
        ...
        this.backfoot2R.setPivot(0.0F, 2.6F, -0.1F);
        this.backfoot2R.addCuboid(-1.5F, -0.4F, -1.0F, 3.0F, 3.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(backfoot2R, -0.570024531038187F, 0.0F, 0.0F);
        this.backleg2R = new WRModelRenderer(this, 37, 49);
        this.backleg2R.setPivot(-1.5F, 2.6F, -0.6F);
        this.backleg2R.addCuboid(-1.5F, -0.5F, -1.5F, 3.0F, 4.0F, 3.0F, -0.1F, 0.0F, 0.0F);
        ...
        this.tailfin3R.setPivot(0.5F, -0.8F, 3.0F);
        this.tailfin3R.addCuboid(-8.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.finger4R.setPivot(-15.0F, -0.77F, -0.5F);
        this.finger4R.addCuboid(-28.0F, -0.5F, -1.0F, 28.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(finger4R, 0.0F, 0.27314402127920984F, 0.0F);
        this.fin11 = new WRModelRenderer(this, 13, 75);
        this.fin11.setPivot(0.0F, -1.5F, 3.0F);
        this.fin11.addCuboid(0.0F, -4.0F, -3.0F, 0.0F, 4.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.fin5 = new WRModelRenderer(this, 22, 72);
        this.fin5.setPivot(0.0F, -2.0F, -1.5F);
        this.fin5.addCuboid(0.0F, -4.0F, -2.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.finger2L = new WRModelRenderer(this, 0, 94);
        this.finger2L.setPivot(15.0F, -0.79F, -2.5F);
        this.finger2L.addCuboid(0.0F, -0.5F, -1.0F, 30.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.finger6R.setPivot(-15.0F, -0.75F, 1.5F);
        this.finger6R.addCuboid(-21.0F, -0.5F, -1.0F, 21.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(finger6R, 0.0F, 0.500909508638178F, 0.0F);
        this.leg1L = new WRModelRenderer(this, 19, 27);
        this.leg1L.setPivot(3.0F, 1.5F, -2.2F);
        this.leg1L.addCuboid(0.0F, -1.1F, -1.5F, 2.0F, 6.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(leg1L, 0.5801474726576871F, 0.0F, 0.0F);
        this.neck4 = new WRModelRenderer(this, 0, 27);
        this.neck4.mirror = true;
        this.neck4.setPivot(0.0F, 0.0F, -2.0F);
        this.neck4.addCuboid(-2.0F, -2.0F, -3.0F, 4.0F, 4.0F, 3.0F, 0.1F, 0.1F, 0.0F);
        ...
        this.finger8R.setPivot(-15.0F, -0.73F, 3.5F);
        this.finger8R.addCuboid(-14.0F, -0.5F, -1.0F, 14.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.foot2R.setPivot(0.0F, 2.6F, 0.1F);
        this.foot2R.addCuboid(-1.5F, -0.4F, -1.0F, 3.0F, 3.0F, 2.0F, -0.15F, 0.0F, 0.0F);
        this.setRotateAngle(foot2R, -0.6410594262680339F, 0.0F, 0.0F);
        this.foot2L = new WRModelRenderer(this, 18, 68);
        this.foot2L.setPivot(0.0F, 2.6F, 0.1F);
        this.foot2L.addCuboid(-1.5F, -0.4F, -1.0F, 3.0F, 3.0F, 2.0F, -0.15F, 0.0F, 0.0F);
        this.setRotateAngle(foot2L, -0.6410594262680339F, 0.0F, 0.0F);
        this.tail3 = new WRModelRenderer(this, 95, 0);
        this.tail3.setPivot(0.0F, 0.0F, 5.0F);
        this.tail3.addCuboid(-2.0F, -2.0F, 0.0F, 4.0F, 4.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.head = new WRModelRenderer(this, 0, 35);
        this.head.setPivot(0.01F, 0.01F, -2.0F);
        this.head.addCuboid(-2.0F, -2.0F, -4.0F, 4.0F, 4.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(head, 0.27279496408408455F, 0.0F, 0.0F);
        this.finger5L = new WRModelRenderer(this, 0, 90);
        this.finger5L.setPivot(15.0F, -0.76F, 0.5F);
        this.finger5L.addCuboid(0.0F, -0.5F, -1.0F, 25.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(finger5L, 0.0F, -0.3642502295386026F, 0.0F);
        this.fin12 = new WRModelRenderer(this, 13, 75);
        this.fin12.setPivot(0.01F, -1.0F, 3.0F);
        this.fin12.addCuboid(0.0F, -4.0F, -3.0F, 0.0F, 4.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.fin9 = new WRModelRenderer(this, 13, 75);
        this.fin9.setPivot(0.0F, -2.0F, 3.0F);
        this.fin9.addCuboid(0.0F, -4.0F, -3.0F, 0.0F, 4.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.tail1 = new WRModelRenderer(this, 72, 0);
        this.tail1.setPivot(0.0F, -0.7F, 8.0F);
        this.tail1.addCuboid(-2.5F, -2.5F, 0.0F, 5.0F, 5.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.tail8 = new WRModelRenderer(this, 135, 0);
        this.tail8.setPivot(0.0F, 0.0F, 4.5F);
        this.tail8.addCuboid(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 5.0F, -0.2F, -0.2F, 0.0F);
        this.tail7 = new WRModelRenderer(this, 135, 0);
        this.tail7.setPivot(0.0F, 0.0F, 4.5F);
        this.tail7.addCuboid(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 5.0F, 0.0F, 0.0F, 0.0F);
        this.teeth1 = new WRModelRenderer(this, 0, 65);
        this.teeth1.setPivot(0.01F, 1.4F, -0.81F);
        this.teeth1.addCuboid(-1.0F, -0.5F, -4.0F, 2.0F, 1.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.backfoot2L = new WRModelRenderer(this, 18, 68);
        this.backfoot2L.setPivot(0.0F, 2.6F, -0.1F);
        this.backfoot2L.addCuboid(-1.5F, -0.4F, -1.0F, 3.0F, 3.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.finger7R.setPivot(-15.0F, -0.74F, 2.5F);
        this.finger7R.addCuboid(-17.0F, -0.5F, -1.0F, 17.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(finger7R, 0.0F, 0.6829473549475088F, 0.0F);
        this.foot1R = new WRModelRenderer(this, 18, 61);
        this.foot1R.setPivot(0.0F, 3.6F, 0.2F);
        this.foot1R.addCuboid(-1.5F, -0.1F, -1.0F, 3.0F, 3.0F, 2.0F, -0.1F, 0.0F, 0.0F);
        ...
        this.finger5R.setPivot(-15.0F, -0.76F, 0.5F);
        this.finger5R.addCuboid(-25.0F, -0.5F, -1.0F, 25.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.finger3R.setPivot(-15.0F, -0.78F, -1.5F);
        this.finger3R.addCuboid(-30.0F, -0.5F, -1.0F, 30.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(finger3R, 0.0F, 0.18203784630933073F, 0.0F);
        this.finger3L = new WRModelRenderer(this, 0, 94);
        this.finger3L.setPivot(15.0F, -0.78F, -1.5F);
        this.finger3L.addCuboid(0.0F, -0.5F, -1.0F, 30.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(finger3L, 0.0F, -0.18203784630933073F, 0.0F);
        this.feathers3R = new WRModelRenderer(this, 27, 38);
        this.feathers3R.setPivot(-7.5F, -0.5F, -3.0F);
        this.feathers3R.addCuboid(-7.5F, -0.5F, -1.5F, 15.0F, 1.0F, 10.0F, -0.1F, -0.2F, 0.0F);
        this.fin13 = new WRModelRenderer(this, 13, 75);
        this.fin13.setPivot(0.0F, -1.0F, 3.0F);
        this.fin13.addCuboid(0.0F, -4.0F, -3.0F, 0.0F, 4.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.finger8L_1 = new WRModelRenderer(this, 122, 86);
        this.finger8L_1.setPivot(15.0F, -0.72F, 4.5F);
        this.finger8L_1.addCuboid(0.0F, -0.5F, -1.0F, 11.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.tailfin1R.setPivot(1.5F, -1.0F, 3.0F);
        this.tailfin1R.addCuboid(-8.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.tailfin4R.setPivot(0.5F, -0.79F, 3.0F);
        this.tailfin4R.addCuboid(-8.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(tailfin4R, 0.0F, 0.17453292519943295F, 0.0F);
        this.fin6 = new WRModelRenderer(this, 15, 81);
        this.fin6.setPivot(0.01F, -2.0F, -1.5F);
        this.fin6.addCuboid(0.0F, -4.0F, -2.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.leg1R = new WRModelRenderer(this, 19, 27);
        this.leg1R.mirror = true;
        this.leg1R.setPivot(-3.0F, 1.5F, -2.2F);
        this.leg1R.addCuboid(-2.0F, -1.1F, -1.5F, 2.0F, 6.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.backleg3L.setPivot(0.0F, 2.8F, 0.1F);
        this.backleg3L.addCuboid(-1.5F, -0.8F, -0.6F, 3.0F, 5.0F, 2.0F, -0.2F, 0.0F, 0.0F);
        this.setRotateAngle(backleg3L, -0.9384635467868342F, 0.0F, 0.0F);
        this.fin10 = new WRModelRenderer(this, 13, 75);
        this.fin10.setPivot(0.01F, -1.5F, 3.0F);
        this.fin10.addCuboid(0.0F, -4.0F, -3.0F, 0.0F, 4.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.backleg1L = new WRModelRenderer(this, 18, 49);
        this.backleg1L.setPivot(2.5F, 0.6F, 6.0F);
        this.backleg1L.addCuboid(0.0F, -1.6F, -2.0F, 3.0F, 5.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(backleg1L, -0.17749998625940386F, 0.0F, 0.0F);
        this.tailfin8L = new WRModelRenderer(this, 54, 64);
        this.tailfin8L.setPivot(0.0F, -0.39F, 3.0F);
        this.tailfin8L.addCuboid(-8.0F, 0.0F, -3.0F, 16.0F, 0.0F, 16.0F, 0.0F, 0.0F, 0.0F);
        this.earR = new WRModelRenderer(this, 0, 68);
        this.earR.setPivot(-2.0F, -1.0F, -2.0F);
        this.earR.addCuboid(0.0F, -4.0F, 0.0F, 0.0F, 4.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(earR, -1.0471975511965976F, -0.45535640450848164F, 0.0F);
        this.neck5 = new WRModelRenderer(this, 0, 27);
        this.neck5.setPivot(0.0F, 0.0F, -2.0F);
        this.neck5.addCuboid(-2.0F, -2.0F, -3.0F, 4.0F, 4.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.backfoot1L.setPivot(0.0F, 3.6F, 0.7F);
        this.backfoot1L.addCuboid(-1.5F, -0.1F, -1.1F, 3.0F, 3.0F, 2.0F, -0.1F, 0.0F, 0.0F);
        ...
        this.finger8R_1.setPivot(-15.0F, -0.72F, 4.5F);
        this.finger8R_1.addCuboid(-11.0F, -0.5F, -1.0F, 11.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.feathers1R.setPivot(-1.5F, -0.5F, 0.5F);
        this.feathers1R.addCuboid(-19.0F, -0.5F, -1.5F, 19.0F, 1.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        this.finger1R = new WRModelRenderer(this, 0, 90);
        this.finger1R.mirror = true;
        this.finger1R.setPivot(-15.0F, -0.8F, -3.5F);
        this.finger1R.addCuboid(-25.0F, -0.5F, -1.0F, 25.0F, 1.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.leg2L = new WRModelRenderer(this, 37, 59);
        this.leg2L.mirror = true;
        this.leg2L.setPivot(1.0F, 4.7F, 0.0F);
        this.leg2L.addCuboid(-1.5F, -0.8F, -1.0F, 3.0F, 5.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.backleg1R.setPivot(-2.5F, 0.6F, 6.0F);
        this.backleg1R.addCuboid(-3.0F, -1.6F, -2.0F, 3.0F, 5.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(backleg1R, -0.17749998625940386F, 0.0F, 0.0F);
        this.fin1 = new WRModelRenderer(this, 13, 72);
        this.fin1.setPivot(0.0F, -2.0F, -1.5F);
        this.fin1.addCuboid(0.0F, -4.0F, -2.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.tailfin5L = new WRModelRenderer(this, 45, 64);
        this.tailfin5L.setPivot(-0.5F, -0.6F, 3.0F);
        this.tailfin5L.addCuboid(0.0F, 0.0F, -3.0F, 8.0F, 0.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(tailfin5L, 0.0F, -0.17453292519943295F, 0.0F);
        this.fin14 = new WRModelRenderer(this, 13, 75);
        this.fin14.setPivot(0.01F, -0.5F, 3.0F);
        this.fin14.addCuboid(0.0F, -4.0F, -3.0F, 0.0F, 4.0F, 6.0F, 0.0F, 0.0F, 0.0F);
    ...
    @Override
    public void setAngles(AlpineEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
        netHeadYaw = MathHelper.wrapDegrees(netHeadYaw);
        if (!entity.isSleeping()) faceTarget(netHeadYaw, headPitch, 1, headArray);
        if (entity.flightTimer.get() == 1) body1.roll = -(netHeadYaw * Mafs.PI / 180f) * 0.4f;
    }

    @Override
    public void animateModel(AlpineEntity entity, float limbSwing, float limbSwingAmount, float partialTick)
    {
        ...
        if (!entity.isSleeping() && !entity.isInSittingPose() && entity.getAnimation() != AlpineEntity.WIND_GUST_ANIMATION)
        {
            if (entity.isFlying()) // flight
            {
                ...
                if (entity.getVelocity().y < 0 && entity.getVelocity().length() > 0.1)
                {
                ...
                boolean wingsDown = wing1R.roll < 0.8;
