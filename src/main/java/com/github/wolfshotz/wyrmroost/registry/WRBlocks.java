...
public class WRBlocks
{
    ...
    public static final RegistryObject<Block> BLUE_OSERI_SAPLING = register("blue_oseri_sapling", () -> new SaplingBlock(new TreeGen(WRWorld.Features.CONFIGURED_BLUE_OSERI_TREE), plant().randomTicks()), extend().render(() -> RenderType::cutout));
    ...
    public static final RegistryObject<Block> GOLD_OSERI_SAPLING = register("gold_oseri_sapling", () -> new SaplingBlock(new TreeGen(WRWorld.Features.CONFIGURED_GOLD_OSERI_TREE), plant().randomTicks()), extend().render(() -> RenderType::cutout));
    ...
    public static final RegistryObject<Block> PINK_OSERI_SAPLING = register("pink_oseri_sapling", () -> new SaplingBlock(new TreeGen(WRWorld.Features.CONFIGURED_PINK_OSERI_TREE), plant().randomTicks()), extend().render(() -> RenderType::cutout));
    ...
    public static final RegistryObject<Block> PURPLE_OSERI_SAPLING = register("purple_oseri_sapling", () -> new SaplingBlock(new TreeGen(WRWorld.Features.CONFIGURED_PURPLE_OSERI_TREE), plant().randomTicks()), extend().render(() -> RenderType::cutout));
    ...
    public static final RegistryObject<Block> WHITE_OSERI_SAPLING = register("white_oseri_sapling", () -> new SaplingBlock(new TreeGen(WRWorld.Features.CONFIGURED_WHITE_OSERI_TREE), plant().randomTicks()), extend().render(() -> RenderType::cutout));
