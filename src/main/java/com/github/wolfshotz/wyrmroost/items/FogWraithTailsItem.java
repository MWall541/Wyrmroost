...
//        {
//            Vec3d position = entity.getEyePosition(1);
//            Vec3d direction = entity.getLookVec();
//            Vec3d end = position.add(direction.mul(10, 10, 10));
...
//                if (tick == 10)
//                {
//                    Vec3d motion = entity.getPositionVec().subtract(new Vec3d(pos));
...
//        if (flag)
//        {
//            attacking.knockBack(attacker, knockback, MathHelper.sin(attacker.rotationYaw * Mafs.PI / 180f), -MathHelper.cos(attacker.rotationYaw * Mafs.PI / 180F));
